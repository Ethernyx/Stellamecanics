...
public class OsmiridiumBlock extends Block implements ICommun {
    private static final String id = "osmiridium_block";
    private final String modelType = "simpleblock";
    private final Map<String, String> translate = new HashMap<String, String>() {{
        put("fr_fr", "Bloc de osmiridium"); put("en_us", "Osmiridium block");
    }};
