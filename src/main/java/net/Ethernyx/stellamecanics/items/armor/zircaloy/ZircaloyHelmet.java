...
public class ZircaloyHelmet extends ArmorItem {
    private static final String id = "zircaloy_helmet";
    ...
    public ZircaloyHelmet() {
        super(CustomArmorMaterials.ZIRCALOY_ARMOR, EquipmentSlot.HEAD, new Item.Settings().group(ModItemsGroup.STELLAMECANICS));
