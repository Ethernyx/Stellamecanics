...
public class LunariumLeggings extends ArmorItem  implements ICommun {
    private static final String id = "lunarium_leggings";
    ...
    public LunariumLeggings() {
        super(CustomArmorMaterials.LUNARIUM_ARMOR, EquipmentSlot.LEGS, new Item.Settings().group(ModItemsGroup.STELLAMECANICS));
