...
public class OsmiridiumHelmet extends ArmorItem {
    private static final String id = "osmiridium_helmet";
    ...
    public OsmiridiumHelmet() {
        super(CustomArmorMaterials.OSMIRIDIUM_ARMOR, EquipmentSlot.HEAD, new Item.Settings().group(ModItemsGroup.STELLAMECANICS));
