...
public class LunariumChestplate extends ArmorItem {
    private final String id = "lunarium_chestplate";
    ...
    public LunariumChestplate() {
        super(CustomArmorMaterials.LUNARIUM_ARMOR, EquipmentSlotType.CHEST, new Properties().tab(ModItemGroups.STELLAMECANICS_TAB));
    }
