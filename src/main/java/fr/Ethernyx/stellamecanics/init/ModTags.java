...
public class ModTags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> IRIDIUM_WEAPON = createTag(new GenericItemTags("iridium_tool", List.of()));
        public static final TagKey<Item> SOLARIUM_WEAPON = createTag(new GenericItemTags("solarium_tool", List.of()));
        public static final TagKey<Item> LUNARIUM_WEAPON = createTag(new GenericItemTags("lunarium_tool", List.of()));
        public static final TagKey<Item> OSMIRIDIUM_WEAPON = createTag(new GenericItemTags("osmiridium_tool", List.of()));
        public static final TagKey<Item> ZIRCONIUM_WEAPON = createTag(new GenericItemTags("zirconium_tool", List.of()));
        public static final TagKey<Item> ZIRCALOY_WEAPON = createTag(new GenericItemTags("zircaloy_tool", List.of()));
        public static final TagKey<Item> STELLARIUM_WEAPON = createTag(new GenericItemTags("stellarium_tool", List.of()));
        public static final TagKey<Item> IRIDIUM_ARMOR = createTag(new GenericItemTags("iridium_tool", List.of()));
        public static final TagKey<Item> SOLARIUM_ARMOR = createTag(new GenericItemTags("solarium_tool", List.of()));
        public static final TagKey<Item> LUNARIUM_ARMOR = createTag(new GenericItemTags("lunarium_tool", List.of()));
        public static final TagKey<Item> OSMIRIDIUM_ARMOR = createTag(new GenericItemTags("osmiridium_tool", List.of()));
        public static final TagKey<Item> ZIRCONIUM_ARMOR = createTag(new GenericItemTags("zirconium_tool", List.of()));
        public static final TagKey<Item> ZIRCALOY_ARMOR = createTag(new GenericItemTags("zircaloy_tool", List.of()));
        public static final TagKey<Item> STELLARIUM_ARMOR = createTag(new GenericItemTags("stellarium_tool", List.of()));
