...
public class ModTags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> OSMIRIDIUM_TOOL    = createTag(new GenericItemTags("iridium_tool", List.of()));
        public static final TagKey<Item> ZIRCONIUM_TOOL   = createTag(new GenericItemTags("solarium_tool", List.of()));
        public static final TagKey<Item> ZIRCALOY_TOOL   = createTag(new GenericItemTags("lunarium_tool", List.of()));
        public static final TagKey<Item> STELLARIUM_TOOL    = createTag(new GenericItemTags("iridium_tool", List.of()));
