...
public class ModBlocks {
    ...
    public static final Block SOLARIUM_ORE = addNewBlock(
            new GenericBlocks("solarium_ore",
                    ...
                    List.of(BlockTags.PICKAXE_MINEABLE, ModTags.Blocks.NEED_IRIDIUM_TOOL),
    ...
    public static final Block ZIRCONIUM_BLOCK = addNewBlock(
            new GenericBlocks("zirconium_block",
                    ...
                    List.of(BlockTags.PICKAXE_MINEABLE,
                            ModTags.Blocks.NEED_LUNARIUM_TOOL,
                            ModTags.Blocks.NEED_SOLARIUM_TOOL,
                            ModTags.Blocks.NEED_ZIRCONIUM_TOOL,
                            ModTags.Blocks.NEED_OSMIRIDIUM_TOOL,
                            ModTags.Blocks.NEED_STELLARIUM_TOOL,
                            ModTags.Blocks.NEED_ZIRCALOY_TOOL),
    ...
    public static final Block IRIDIUM_BLOCK = addNewBlock(
            new GenericBlocks("iridium_block",
                    ...
                    List.of(BlockTags.PICKAXE_MINEABLE,
                            ModTags.Blocks.NEED_IRIDIUM_TOOL,
                            ModTags.Blocks.NEED_LUNARIUM_TOOL,
                            ModTags.Blocks.NEED_SOLARIUM_TOOL,
                            ModTags.Blocks.NEED_ZIRCONIUM_TOOL,
                            ModTags.Blocks.NEED_OSMIRIDIUM_TOOL,
