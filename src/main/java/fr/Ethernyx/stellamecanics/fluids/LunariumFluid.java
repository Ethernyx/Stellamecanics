...
public abstract class LunariumFluid extends FlowableFluid implements IMyFlowingFluid {
    ...
    @Override public int color()                                    { return 0xC8D8E8; }
    ...
    @Override public String stillId()                               { return "lunarium_fluid_still"; }
    @Override public String flowingId()                             { return "lunarium_fluid_flowing"; }
    @Override public String blockId()                               { return "lunarium_fluid_block"; }
    @Override public String bucketId()                              { return "lunarium_fluid_bucket"; }
    ...
    public String getTranslate(String lang, FluidListTypeEnum type) {
        ...
        Map<String, String> bucket = new HashMap<>() {{
            put("fr_fr", "Bucket de lunarium");
            put("en_us", "Lunarium bucket");
        }};
